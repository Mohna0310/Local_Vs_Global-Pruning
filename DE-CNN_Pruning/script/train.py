...
class lr_scheduler_list:
    ...
    def __init__(self, optimizer):
        self.lr_scheduler_list = [ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=100, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dropout', type=float, default=0.45) # 0.55
    ...
    if args.pruning == 'local':
        ...
        pruning_frac =  [0.15, 0.25, 0.35, 0.43,0.53,0.63,0.71,0.81,0.91,0.96] 
